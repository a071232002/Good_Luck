...
<% //見com.pro.controller.ProServlet.java第163行存入req的proVO物件 (此為從資料庫取出的proVO, 也可以是輸入格式有錯誤時的proVO物件)
   ProVO proVO = (ProVO) request.getAttribute("proVO");
%>
<%= proVO==null %>--${proVO.tagNo}-- <!-- line 100 -->
<html>
<head>
...
<FORM METHOD="post" ACTION="pro.do" name="form1" enctype="multipart/form-data">
		<table>
			...
			<c:if test="${not empty proVO.proImg}">
				<td><img src="data:image/jpeg;base64,${proVO.proImgBase64}" alt="Product Image"   style="width: 130px; max-height: 130px;">
        </c:if>
...
<script>
        ...
        $('#f_date1').datetimepicker({
           theme: '',              //theme: 'dark',
 		   ...
 		   value: '<%=proVO.getProCreateTime()%>', // value:   new Date(),
