...
//		model.addAttribute("notice", notice);
	...
	public String updateData(ModelMap model,@ModelAttribute("noticeNo") String noticeNo) {
		...
		Notice oldData=noticeservice.getOneNotice(Integer.valueOf(noticeNo));
	...
	public String addNotice(@RequestParam("noticePic")MultipartFile part,@ModelAttribute("notice")@Valid Notice notice,BindingResult result,ModelMap model)throws IOException{
...
//		notice.setNoticePic(part.isEmpty() ? null : part.getBytes());
		...
		Notice newData = noticeservice.getOneNotice(noticeservice.addNotice(notice).getNoticeno());
		model.addAttribute("sucessData",newData);
		System.out.println(newData);
		return"BackStage/notice/successPage";
//		return"redirect:/notice/noticelist";
		...
		public String updateNotice(@RequestParam("noticePic")MultipartFile part, @ModelAttribute("data") @Valid Notice notice, BindingResult result, ModelMap model) throws IOException{
...
//			return "redirect:/notice/noticelist";
		...
		public BindingResult removeFieldError(Notice notice, BindingResult result, String removedFieldname) {
			List<FieldError> errorsListToKeep = result.getFieldErrors().stream()
					.filter(fieldname -> !fieldname.getField().equals(removedFieldname))
					.collect(Collectors.toList());
			result = new BeanPropertyBindingResult(notice, "notice");
		...
		//圖片處理
//		@GetMapping("picture")
//		public void dBGifReader(@RequestParam("noticeno") String noticeNo, HttpServletRequest req, HttpServletResponse res)
//				                                                                                          throws IOException {
//			res.setContentType("image/jpg");
//			ServletOutputStream out = res.getOutputStream();
//
//			try {
//				out.write(noticeservice.findByNoticeNo(Integer.valueOf(noticeNo)).getNoticePic());
//			} catch (Exception e) {
