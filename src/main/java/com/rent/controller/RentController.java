...
//	}
	...
	public String reviewRentApp(Model model) {
		...
		return "BackStage/rent/rentManagement";
	}
    
    @PostMapping("updateRentSt")
...
//	}
	...
	public void pictureImg (@RequestParam("rentNo") String rentNo,
		...
		try {
			out.write(rentSvc.getOneRent(Integer.valueOf(rentNo)).getRentImg());
		} catch (Exception e) {
	...
	@GetMapping("pictureOwn")
	public void pictureOwn (@RequestParam("rentNo") String rentNo,
			HttpServletRequest req, 
			HttpServletResponse res) throws IOException {
		...
		try {
			out.write(rentSvc.getOneRent(Integer.valueOf(rentNo)).getRentAppOwn());
		} catch (Exception e) {
			byte[] buf = java.util.Base64.getDecoder().decode("");
			out.write(buf);
		}
...
//		}
	...
	public BindingResult removeFieldError(Rent rent, BindingResult result, String removedFieldname) {
