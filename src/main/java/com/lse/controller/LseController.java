...
public class LseController {
	...
	public String updateData(ModelMap model, @RequestParam("lseNo") String lseNo, HttpSession session) {
		...
		if (ldd == null) {
			...
			Lse dataORI = lseSvc.getOneByLseNo(Integer.valueOf(lseNo));
			
			String[] parts = dataORI.getLsePayAccount().split("\\s+");
	...
	@PostMapping("update")
	public String update(@RequestParam("lseSend") MultipartFile part,
						 @Valid Lse lse, BindingResult result, 
						 ModelMap model,
						 @RequestParam("bank") String bank, 
						 @RequestParam("account") String account) throws IOException {
	...
	public String sign(@RequestParam("lseSign") MultipartFile part,
					   @RequestParam("lseNo") String lseNo) throws IOException {
		Lse lse = lseSvc.getOneByLseNo(Integer.valueOf(lseNo));
	...
	@GetMapping("sendPic")
	public void sendPicReader (@RequestParam("lseNo") String lseNo,
			HttpServletRequest req, HttpServletResponse res) throws IOException {
		res.setContentType("image/png");
		ServletOutputStream out = res.getOutputStream();
		try {
			out.write(lseSvc.getOneByLseNo(Integer.valueOf(lseNo)).getLseSend());
		} catch (Exception e) {
	...
	public void signPicReader (@RequestParam("lseNo") String lseNo,
		...
		ServletOutputStream out = res.getOutputStream();
		try {
			out.write(lseSvc.getOneByLseNo(Integer.valueOf(lseNo)).getLseSign());
		} catch (Exception e) {
	        byte[] buf = java.util.Base64.getDecoder().decode("");
			out.write(buf);
		}	
